package com.example.chapter21.engine.scene;

import org.joml.*;
import org.lwjgl.PointerBuffer;
import org.lwjgl.assimp.*;
import org.lwjgl.system.MemoryStack;
import com.example.chapter21.engine.Utils;
import com.example.chapter21.engine.graph.*;
...
public class ModelLoader {
    ...
    private static void buildFrameMatrices(AIAnimation aiAnimation, List<Bone> boneList, Model.AnimatedFrame animatedFrame,
        ...
        Bone[] affectedBones = (Bone[]) boneList.stream().filter(b -> b.boneName.equals(nodeName)).toArray();
    ...
    public static class AnimMeshData {
        ...
        public int[] boneIds;
        public AnimMeshData(float[] weights, int[] boneIds){
