...
import com.example.chapter21.engine.scene.*;
...
public class RenderBuffers {
    ...
    public void loadAnimatedModels(Scene scene) {
        List<Model> modelList = new ArrayList<Model>(Arrays.asList((Model[])scene.getModelMap().values().stream().filter(Model::isAnimated).toArray()));
    ...
    public void loadStaticModels(Scene scene) {
        Model[] modelList = (Model[]) scene.getModelMap().values().stream().filter(m -> !m.isAnimated()).toArray();
    ...
    public static class AnimMeshDrawData {
        ...
        public int bindingPoseOffset;
        public int weightsOffset;
        public AnimMeshDrawData(Entity entity, int bindingPoseOffset, int weightsOffset){
            this.entity = entity;
            this.bindingPoseOffset = bindingPoseOffset;
            this.weightsOffset = weightsOffset;
        }
    }
    ...
    public static class MeshDrawData {
        ...
        public int offset;
        public int vertices;
        public AnimMeshDrawData animMeshDrawData;
        public MeshDrawData(int sizeInBytes, int materialIdx, int offset, int vertices, AnimMeshDrawData animMeshDrawData){
            this.sizeInBytes = sizeInBytes;
            this.materialIdx = materialIdx;
            this.offset = offset;
            this.vertices = vertices;
            this.animMeshDrawData = animMeshDrawData;
        }
