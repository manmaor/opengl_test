...
//    runtimeOnly("org.lwjgl", "lwjgl-ovr", classifier = lwjglNatives) // oculus sdk
    ...
    if (lwjglNatives != "natives-macos-arm64") runtimeOnly("org.lwjgl", "lwjgl-sse", classifier = lwjglNatives)
    ...
    if (lwjglNatives != "natives-macos-arm64") runtimeOnly("org.lwjgl", "lwjgl-tootle", classifier = lwjglNatives)
